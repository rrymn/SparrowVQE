...
class SparrowModel(LlavaMetaModel, PhiModel):
    config_class = SparrowConfig

    def __init__(self, config: SparrowConfig):
        super(SparrowModel, self).__init__(config)


class SparrowForCausalLM(PhiForCausalLM, LlavaMetaForCausalLM):
    config_class = SparrowConfig

    def __init__(self, config):
        super(SparrowForCausalLM, self).__init__(config)
        self.transformer = SparrowModel(config)
...
AutoModelForCausalLM.register(SparrowConfig, SparrowForCausalLM)
